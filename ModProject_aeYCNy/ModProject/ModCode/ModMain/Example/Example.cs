...
namespace MOD_aeYCNy
{
    ...
    public class Example
    {
        ...
        private void TestTimer()
        {
            ...
            int frameCount = 0;
            cor1 = g.timer.Frame(new System.Action(() => {
                frameCount++;
    ...
    public class ExampleTestMono : MonoBehaviour
    {
        ...
        public ExampleTestMono(System.IntPtr ptr) : base(ptr) { }

        void Update()
        {
            UnityEngine.CharacterController controller = gameObject.GetComponent<CharacterController>();
            AIHumanState aIHumanState = new AIHumanState();
            WorldUnitData worldUnitData = new WorldUnitData();
            Il2CppSystem.Collections.Generic.List<int> list = worldUnitData.GetCharacter();
            System.Console.WriteLine(list.ToString());
            UnitCtrlHuman unitCtrlHuman =  aIHumanState.unitHuman;

            Debug.Log(Time.frameCount + "，每帧打印");
            System.Console.WriteLine(Time.frameCount + "，每帧打印");
        }
    }
}
